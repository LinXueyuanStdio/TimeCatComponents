...
public class LetMeKnow {
    ...
    public static final String CLICK_SETTINGS_SET_STYLE_TIMECAT = "click_settings_set_style_timecat";
    ...
    public static final String CLICK_SETTINGS_CHECK_UPDATE = "click_settings_check_update";
    ...
    public static final String CLICK_OCR_TO_TIMECAT_ACTIVITY = "click_ocr_to_timecat_activity";
    ...
    public static final String CLICK_TIMECAT_REMAIN_SYMBOL = "click_timecat_remain_symbol";
    public static final String CLICK_TIMECAT_REMAIN_SECTION = "click_timecat_remain_section";
    public static final String CLICK_TIMECAT_DRAG_SELECTION = "click_timecat_drag_selection";
    ...
    public static final String CLICK_CAPTURERESULT_TIMECAT = "click_captureresult_timecat";
