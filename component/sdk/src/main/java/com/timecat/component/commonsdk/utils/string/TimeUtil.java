...
public class TimeUtil {
     ...
     * @param mss 要转换的毫秒数
     *
     * @return 该毫秒数转换为 5 hours
     */
    public static long getHours(long mss) {
     ...
     * @param mss 要转换的毫秒数
     *
     * @return 该毫秒数转换为 5 minutes
     */
    public static long getMinutes(long mss) {
     ...
     * @param mss 要转换的毫秒数
     *
     * @return 该毫秒数转换为 5 seconds
     */
    public static long getSeconds(long mss) {
...
//        dateFormatGmt.setTimeZone(TimeZone.getTimeZone("GMT"));
     ...
     * Mon Feb 19 16:11:11 UTC 2018
     */
    public static DateTime formatGMTDateTimeStr(String gmt_datetime) {
        //Time in GMT
        SimpleDateFormat dateFormatGmt = new SimpleDateFormat("yyyy-MM-dd'T'HH:mm:ss.SSS");
//        dateFormatGmt.setTimeZone(TimeZone.getTimeZone("GMT"));
        try {
            return new DateTime(dateFormatGmt.parse(gmt_datetime));
        } catch (ParseException e) {
            e.printStackTrace();
            return null;
        }
    ...
    public static String formatMonthDay(Date d) {
        SimpleDateFormat dateFormatGmt = new SimpleDateFormat("MM月dd日", Locale.CHINA);
//        dateFormatGmt.setTimeZone(TimeZone.getTimeZone("GMT"));
        return dateFormatGmt.format(d);
    }

    public static String format2yyyyMMdd(Date d) {
        SimpleDateFormat dateFormatGmt = new SimpleDateFormat("yyyyMMdd", Locale.CHINA);
//        dateFormatGmt.setTimeZone(TimeZone.getTimeZone("GMT"));
        return dateFormatGmt.format(d);
    }
