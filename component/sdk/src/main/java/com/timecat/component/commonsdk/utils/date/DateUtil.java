package com.timecat.component.commonsdk.utils.date;
...
public class DateUtil {
     ...
     *
     * @param dateStr
     * @param type    "date":返回日期(yyyy-MM-dd)
     *                "time":返回时间(HH:mm:ss)
     *                "datetime":返回日期和时间(yyyy-MM-dd HH:mm:ss)
     *
     * @return
    ...
    public static long getZeroClockTimestamp(long time) {
        ...
        Log.d("timecat", " DateTransUtils-getZeroClockTimestamp()  获取当日00:00:00的时间戳,东八区则为早上八点 :" + currentStamp);
        return currentStamp;
    }
